...
class CategoryViewController: UIViewController {
    ...
    private func setupLayout() {
        NSLayoutConstraint.activate([
            ...
            titleViewController.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 27),
...
extension CategoryViewController: UITableViewDataSource {
    ...
    func tableView(
        ...
        guard let categoryCell = tableView.dequeueReusableCell(withIdentifier: CategoryTableCell.identifier) as? CategoryTableCell else {
